...
# ESCALA DE RISCO (campo 'risco'): 1 = MINIMO, 10 = MAXIMO.
# Invertida em 04/07/2026 -- a versao original usava 1=mais arriscado,
# 10=mais seguro (Cripto=1, Renda Fixa=9-10), o que e contraintuitivo;
# Victor apontou que o esperado e 10=risco maximo. Escala atual:
# Renda Fixa curta ~1, Renda Fixa longa ~2, High income ~3,
# Ouro/Cambio ~4, Dividendo/Value ~5, Real Estate ~6, Indice amplo ~7,
# Small/Mid cap ~8, Setorial ~9, Cripto ~10. ETF_RISCO_LABEL em app.js
...
ETF_UNIVERSO = [
    ...
    {'ticker':'PIBB11','mercado':'Nacional','categoria':'Índice Brasil','desc':'IBrX-50','risco':7},
    {'ticker':'IVVB11','mercado':'Nacional','categoria':'Americano','desc':'S&P 500 (BDR)','risco':7},
    {'ticker':'NASD11','mercado':'Nacional','categoria':'Americano','desc':'Nasdaq-100 (BDR)','risco':7},
    {'ticker':'SPXR11','mercado':'Nacional','categoria':'Americano','desc':'S&P 500 Futures BRL','risco':7},
    {'ticker':'SPXH11','mercado':'Nacional','categoria':'Americano','desc':'S&P 500 (hedge cambial)','risco':7},
    {'ticker':'TECK11','mercado':'Nacional','categoria':'Americano','desc':'Tecnologia (Brasil/América)','risco':9},
    {'ticker':'LFTB11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro Selic','risco':1},
    {'ticker':'LFTS11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro Selic','risco':1},
    {'ticker':'LFTI11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro Selic','risco':1},
    {'ticker':'LLFT11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro Selic','risco':1},
    {'ticker':'IMAB11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro IPCA+ (IMA-B)','risco':2},
    {'ticker':'IRFM11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro Prefixado','risco':1},
    {'ticker':'B5P211','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro IPCA+ 2 anos','risco':2},
    {'ticker':'B5MB11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro/crédito','risco':1},
    {'ticker':'IB5M11','mercado':'Nacional','categoria':'Renda Fixa','desc':'Tesouro','risco':1},
    {'ticker':'HASH11','mercado':'Nacional','categoria':'Cripto','desc':'Cesta cripto (Nasdaq Crypto Index)','risco':10},
    {'ticker':'QBTC11','mercado':'Nacional','categoria':'Cripto','desc':'Bitcoin','risco':10},
    {'ticker':'BITI11','mercado':'Nacional','categoria':'Cripto','desc':'Bitcoin','risco':10},
    {'ticker':'BITH11','mercado':'Nacional','categoria':'Cripto','desc':'Bitcoin (hedge)','risco':10},
    {'ticker':'ETHE11','mercado':'Nacional','categoria':'Cripto','desc':'Ethereum','risco':10},
    {'ticker':'GOLD11','mercado':'Nacional','categoria':'Ouro/Commodities','desc':'Ouro (LBMA)','risco':4},
    {'ticker':'MARG11','mercado':'Nacional','categoria':'Ouro/Commodities','desc':'Commodities/margem','risco':4},
    {'ticker':'DOLA11','mercado':'Nacional','categoria':'Câmbio','desc':'Dólar','risco':4},
    {'ticker':'WRLD11','mercado':'Nacional','categoria':'Internacional','desc':'Global All Cap (mundo todo)','risco':7},
    {'ticker':'XINA11','mercado':'Nacional','categoria':'Internacional','desc':'China','risco':7},
    {'ticker':'USAL11','mercado':'Nacional','categoria':'Internacional','desc':'EUA amplo','risco':7},
    {'ticker':'PACG11','mercado':'Nacional','categoria':'Internacional','desc':'Ásia-Pacífico','risco':7},
    {'ticker':'VOO','mercado':'Americano','categoria':'Índice amplo','desc':'S&P 500','risco':7},
    {'ticker':'VTI','mercado':'Americano','categoria':'Índice amplo','desc':'Total Stock Market EUA','risco':7},
    {'ticker':'QQQ','mercado':'Americano','categoria':'Índice amplo','desc':'Nasdaq-100','risco':7},
    {'ticker':'JEPI','mercado':'Americano','categoria':'High income','desc':'S&P 500 high income','risco':3},
    {'ticker':'JEPQ','mercado':'Americano','categoria':'High income','desc':'Nasdaq high income','risco':3},
    {'ticker':'VT','mercado':'Americano','categoria':'Internacional','desc':'Total World (global)','risco':7},
    {'ticker':'VUG','mercado':'Americano','categoria':'Índice amplo','desc':'Growth (crescimento)','risco':7},
    {'ticker':'VTV','mercado':'Americano','categoria':'Dividendo/Value','desc':'Value (valor)','risco':5},
    {'ticker':'SCHD','mercado':'Americano','categoria':'Dividendo/Value','desc':'Dividend Equity','risco':5},
    {'ticker':'VGT','mercado':'Americano','categoria':'Setorial','desc':'Tecnologia (setor)','risco':9},
    {'ticker':'SMH','mercado':'Americano','categoria':'Setorial','desc':'Semicondutores','risco':9},
    {'ticker':'VEA','mercado':'Americano','categoria':'Internacional','desc':'Mercados desenvolvidos ex-EUA','risco':7},
    {'ticker':'VWO','mercado':'Americano','categoria':'Internacional','desc':'Mercados emergentes','risco':7},
    {'ticker':'IJR','mercado':'Americano','categoria':'Small/Mid cap','desc':'Small Cap','risco':8},
    {'ticker':'IJH','mercado':'Americano','categoria':'Small/Mid cap','desc':'Mid Cap','risco':8},
    {'ticker':'GLD','mercado':'Americano','categoria':'Ouro/Commodities','desc':'Ouro','risco':4},
    {'ticker':'SLV','mercado':'Americano','categoria':'Ouro/Commodities','desc':'Prata','risco':4},
    {'ticker':'IBIT','mercado':'Americano','categoria':'Cripto','desc':'Bitcoin','risco':10},
    {'ticker':'VNQ','mercado':'Americano','categoria':'Real Estate','desc':'REITs EUA','risco':6},
    {'ticker':'BND','mercado':'Americano','categoria':'Renda Fixa','desc':'Bond total EUA','risco':1},
    {'ticker':'SGOV','mercado':'Americano','categoria':'Renda Fixa','desc':'Treasury curtíssimo','risco':1},
    {'ticker':'TLT','mercado':'Americano','categoria':'Renda Fixa','desc':'Treasury longo (20+ anos)','risco':2},
    {'ticker':'JPST','mercado':'Americano','categoria':'Renda Fixa','desc':'Ultra-short income','risco':1},
    {'ticker':'XLE','mercado':'Americano','categoria':'Setorial','desc':'Energia','risco':9},
    {'ticker':'EWJ','mercado':'Americano','categoria':'Internacional','desc':'Japão','risco':7},
    {'ticker':'EWY','mercado':'Americano','categoria':'Internacional','desc':'Coreia do Sul','risco':7},
]
