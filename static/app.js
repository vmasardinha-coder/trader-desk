...
const SEG={
  ...
  cn: ['ABEV3','JBSS3','BRFS3','NATU3','MDIA3','BEEF3','SLCE3','MTRE3','CAML3','PCAR3'],
  sau:['RDOR3','HAPV3','FLRY3','DASA3','QUAL3','ONCO3','PNVL3','ODPV3','MATD3','AALR3'],
  ind:['WEGE3','EMBR3','RAIL3','TGMA3','ROMI3','VLID3','TUPY3','IRBR3','POMO4','LAVV3'],
  tit:['VIVT3','TIMS3','TOTVS3','POSI3','MLAS3','ANIM3','INTB3','LWSA3','CASH3','OIBR3'],
};
const USSEG={
